...
function restart()
    ...
    radiation_x = -10
    radiation_particles = {}
    spawn_from_map(LEVELS[1])
end

function spawn_from_map(level)
    for tile_x=level.y_tile_min, level.y_tile_max do
        for tile_y=level.x_tile_min, level.x_tile_max do
            tile = mget(tile_x, tile_y)
            if tile == ENTANGLED_BLOCK_A then
                mset(tile_x, tile_y, 0)
            elseif tile == ENTANGLED_BLOCK_B then
                mset(tile_x, tile_y, 0)
            end
        end
    end
...
-- 005:
...
-- 011:
